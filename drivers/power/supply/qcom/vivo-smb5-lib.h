...
struct smb_charger {
	...
	struct delayed_work	otg_oc_work;//vivo add
	struct delayed_work	pr_lock_clear_work;
	struct delayed_work	typec_state_verification_work;//vivo add
	struct delayed_work	force_9v_hvdcp_work;//vivo add
...
irqreturn_t otg_oc_disable_sw_irq_handler(int irq, void *data);//vivo add
